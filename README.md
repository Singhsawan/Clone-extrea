![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=𝑊𝑒𝑙𝑐𝑜𝑚𝑒+𝑇𝑜+jonny!;𝐶𝑟𝑒𝑎𝑡𝑒𝑑+𝑏𝑦+𝐓𝐆+ᠰ+𝐓𝐆!;𝐴+𝑠𝑖𝑚𝑝𝑙𝑒+𝑎𝑛𝑑+𝑝𝑜𝑤𝑒𝑟𝑓𝑢𝑙+𝐵𝑜𝑡!;𝐼𝑛𝑑𝑒𝑥𝑒𝑠+𝐹𝑖𝑙𝑒𝑠+𝑎𝑏𝑜𝑣𝑒+2𝐺𝐵;𝐴+𝐵𝑜𝑡+𝑤𝑖𝑡ℎ+𝑑𝑜𝑢𝑏𝑙𝑒+𝑏𝑢𝑡𝑡𝑜𝑛!;𝑆𝑡𝑎𝑟𝑡+𝑚𝑒𝑠𝑠𝑎𝑔𝑒+𝑤𝑖𝑡ℎ+𝑝𝑖𝑐!;𝐴𝑛𝑑+𝑚𝑜𝑟𝑒+𝑓𝑒𝑎𝑡𝑢𝑟𝑒𝑠!)
</p>
...
<b>𝑇𝑜 𝑘𝑛𝑜𝑤 𝑎𝑏𝑜𝑢𝑡 𝑎𝑙𝑙 𝑓𝑒𝑎𝑡𝑢𝑟𝑒𝑠, 𝐽𝑜𝑖𝑛 𝑜𝑢𝑟 <a href='https://t.me/Royal_Enfield_bot_Updates'>𝑢𝑝𝑑𝑎𝑡𝑒𝑠 𝑐ℎ𝑎𝑛𝑛𝑒𝑙</a>.</b>

## 𝐶𝑜𝑚𝑚𝑎𝑛𝑑𝑠
```
start - ✨CHECK ALIVE/GET FILES
stats - 👨‍💻 BOT STATS
ping - ⚮ Pong 
connect - 😇CONNECT TO A GROUP
info - ℹ️ GET UR INFO
imdb - 📇 SET IMDB INFO
users - 💗LIST OF TOTAL USERS
index - 📂 INDEX FILES
chats  - 🕳️TOTAL CHATS INFO
broadcast - 🔮BROADCAST (ADMIN ONLY)
ban - 🤕BAN ANY USER (ADMIN ONLY)
unban - 🙇UNBAN ANY USER (ADMIN ONLY)
link - 🔗 LINK TO HOST (ADMIN ONLY)
```
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Sridhark01/DQ-_BULLET">
...
<p>
<pre>
git clone https://github.com/maharaja91/DQ-_TOM/tree/main
# Install Packages
...
* [![AJ](https://img.shields.io/static/v1?label=Aᴊ+ᠰ+Tɢ&message=Github&color=critical)](https://github.com/AKSER256)
* [![Contact](https://img.shields.io/static/v1?label=Contact+Developer&message=On+Telegram&color=critical)](https://telegram.me/at_xu_l07)

## Thanks to 
 - Thanks To All Everyone In This Journey❤️‍🩹
 - Thanks to dev❣️
 - Thanks To [AJ tg](https://t.me/at_xu_l07) who have edited and modified this repo as now it is. (It's me 😂)
...
* [![Contact Developer](https://img.shields.io/static/v1?label=Contact+Developer&message=On+Telegram&color=critical)](https://telegram.me/at_xu_l07)
